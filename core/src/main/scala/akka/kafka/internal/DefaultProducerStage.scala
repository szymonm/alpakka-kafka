...
private class DefaultProducerStageLogic[K, V, P, IN <: Envelope[K, V, P], OUT <: Results[K, V, P]](
  ...
  override def onMessageAckCb(metadata: RecordMetadata, env: Envelope[K, V, P]): Unit = {}
